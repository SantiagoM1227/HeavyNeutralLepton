#include "../bin/ATLAS/Ve1_mass_30.h"
#include "../bin/ATLAS/Ve1_mass_30.C"
...
//define path 
   ...
   */
   ...
   leg->SetHeader("#sqrt{s} = 13 TeV, 1 pb^{-1}");
...
void Ve1_mass_30(void){
   ...
   Graph_With_Background(HNL.hist_Muplus_pt, ZMUMU.hist_Muplus_pt, QCD.hist_Muplus_pt, WMUVM.hist_Muplus_pt, "Ve1_mass_5_Bkg_Muplus", "HeavyNL x 1e12", "Z -> MuMu", "QCD", "W -> Mu v", false);
      
   
   Graph_With_Background(HNL.hist_Muminus_pt, ZMUMU.hist_Muminus_pt, QCD.hist_Muminus_pt, WMUVM.hist_Muminus_pt, "Ve1_mass_5_Bkg_Muminus", "HeavyNL x 1e12", "Z -> MuMu", "QCD", "W -> Mu v", false);
   
   
   Graph_Histogram_one(HNL.N_invMass, "N_invmass_Ve1_mass_5", "N_invmass_Ve1_mass_5 x 1e12", false);
   
   Graph_Histogram_one(HNL.hist_MuW_eta, "MuW_eta_Ve1_mass_5", "hist_MuW_eta_Ve1_mass_5 x 1e12", false);
   Graph_Histogram_one(HNL.hist_MuW_phi, "MuW_phi_Ve1_mass_5", "hist_MuW_phi_Ve1_mass_5 x 1e12", false);
   


   Graph_With_Background(HNL.hist_MuW_pt, ZMUMU.hist_MuW_pt, QCD.hist_MuW_pt, WMUVM.hist_MuW_pt, "Ve1_mass_5_Bkg", "HeavyNL x 1e12", "Z -> MuMu", "QCD", "W -> Mu v", false);
