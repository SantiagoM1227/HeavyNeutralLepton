#include "../bin/ATLAS/Ve2_mass_45.h"
#include "../bin/ATLAS/Ve2_mass_45.C"
...
void Ve2_mass_45(void){
   
   class Ve2_mass_45 HNL;
   ...
   Graph_With_Background(HNL.hist_Muplus_pt, ZMUMU.hist_Muplus_pt, QCD.hist_Muplus_pt, WMUVM.hist_Muplus_pt, "Ve2_mass_35_Bkg_Muplus", "HeavyNL x 1e13", "Z -> MuMu", "QCD", "W -> Mu v", false);
   
   
   Graph_Histogram(ZMUMU.N_invMass, HNL.N_invMass, "N_invmass_Ve2_mass_35_HNL_ZMUMU","Z->Mu Mu", "HNL",  false);
      
   
   Graph_With_Background(HNL.hist_Muminus_pt, ZMUMU.hist_Muminus_pt, QCD.hist_Muminus_pt, WMUVM.hist_Muminus_pt, "Ve2_mass_35_Bkg_Muminus", "HeavyNL x 1e13", "Z -> MuMu", "QCD", "W -> Mu v", false);
   
   
   Graph_Histogram_one(HNL.N_invMass, "N_invmass_Ve2_mass_35", "N_invmass_Ve2_mass_35", false);
   Graph_Histogram_one(HNL.hist_Muplus_eta, "MuW_eta_Ve2_mass_35", "hist_MuW_eta_Ve2_mass_35 x 1e13", false);
   Graph_Histogram_one(HNL.hist_Muplus_phi, "MuW_phi_Ve2_mass_35", "hist_MuW_phi_Ve2_mass_35 x 1e13", false);

   Graph_With_Background(HNL.hist_MuW_pt, ZMUMU.hist_MuW_pt, QCD.hist_MuW_pt, WMUVM.hist_MuW_pt, "Ve2_mass_35_Bkg", "HeavyNL x 1e13", "Z -> MuMu", "QCD", "W -> Mu v", false);
