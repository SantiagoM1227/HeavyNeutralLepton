#define Background_Z_MUMU_cxx
#include "Background_Z_MUMU.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <fstream>
...
void Background_Z_MUMU::Loop()
{
//   In a ROOT session, you can do:
//      root> .L Background_Z_MUMU.C
//      root> Background_Z_MUMU t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      /*
      hist_MuW_pt -> Scale(0.5);
      hist_MuN_pt -> Scale(0.5);
      hist_jet_pt -> Scale(0.5);
      */
   }
