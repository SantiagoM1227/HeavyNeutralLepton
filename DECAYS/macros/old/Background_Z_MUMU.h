...
// Tue Mar 14 13:31:24 2023 by ROOT version 6.26/06
// from TTree Delphes/Analysis tree
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/Z_MUMU/Events/run_02/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Background_Z_MUMU_h
#define Background_Z_MUMU_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3584;
   static constexpr Int_t kMaxTrack = 136;
   static constexpr Int_t kMaxTower = 255;
   static constexpr Int_t kMaxEFlowTrack = 136;
   static constexpr Int_t kMaxEFlowPhoton = 84;
   static constexpr Int_t kMaxEFlowNeutralHadron = 147;
   ...
   Background_Z_MUMU(TTree *tree=0);
   virtual ~Background_Z_MUMU();
...
#ifdef Background_Z_MUMU_cxx
Background_Z_MUMU::Background_Z_MUMU(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/Z_MUMU/Events/run_02/tag_1_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/Z_MUMU/Events/run_02/tag_1_delphes_events.root");
      }
...
Background_Z_MUMU::~Background_Z_MUMU()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Background_Z_MUMU::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Background_Z_MUMU::LoadTree(Long64_t entry)
{
...
void Background_Z_MUMU::Init(TTree *tree)
{
...
Bool_t Background_Z_MUMU::Notify()
{
...
void Background_Z_MUMU::Show(Long64_t entry)
{
...
Int_t Background_Z_MUMU::Cut(Long64_t entry)
{
...
#endif // #ifdef Background_Z_MUMU_cxx
