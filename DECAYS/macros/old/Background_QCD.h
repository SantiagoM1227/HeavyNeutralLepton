...
// Tue Mar 14 13:32:21 2023 by ROOT version 6.26/06
// from TTree Delphes/Analysis tree
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/QCD/Events/run_02/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Background_QCD_h
#define Background_QCD_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3629;
   static constexpr Int_t kMaxTrack = 132;
   static constexpr Int_t kMaxTower = 256;
   static constexpr Int_t kMaxEFlowTrack = 132;
   ...
   Background_QCD(TTree *tree=0);
   virtual ~Background_QCD();
...
#ifdef Background_QCD_cxx
Background_QCD::Background_QCD(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/QCD/Events/run_02/tag_1_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/QCD/Events/run_02/tag_1_delphes_events.root");
      }
...
Background_QCD::~Background_QCD()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Background_QCD::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Background_QCD::LoadTree(Long64_t entry)
{
...
void Background_QCD::Init(TTree *tree)
{
...
void Background_QCD::Show(Long64_t entry)
{
...
Int_t Background_QCD::Cut(Long64_t entry)
{
...
#endif // #ifdef Background_QCD_cxx
