...
// Tue Mar 14 13:29:35 2023 by ROOT version 6.26/06
// from TTree Delphes/Analysis tree
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/W_MUVM/Events/run_02/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Background_W_MUVM_h
#define Background_W_MUVM_h
...
public :
   ...
   TH1F *hist_MuW_pt = new TH1F("pT for #mu W","pT for #mu W(GeV); (#mu W)pT(GeV); Events",50,0,50);
   TH1F *hist_MuN_pt = new TH1F("pT for #mu N","pT for #mu N(GeV); (#mu N)pT(GeV); Events",50,0,50);      
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxTrack = 139;
   static constexpr Int_t kMaxTower = 245;
   static constexpr Int_t kMaxEFlowTrack = 139;
   static constexpr Int_t kMaxEFlowPhoton = 85;
   static constexpr Int_t kMaxEFlowNeutralHadron = 142;
   ...
   Background_W_MUVM(TTree *tree=0);
   virtual ~Background_W_MUVM();
...
#ifdef Background_W_MUVM_cxx
Background_W_MUVM::Background_W_MUVM(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/W_MUVM/Events/run_02/tag_1_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/W_MUVM/Events/run_02/tag_1_delphes_events.root");
      }
...
Background_W_MUVM::~Background_W_MUVM()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Background_W_MUVM::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Background_W_MUVM::LoadTree(Long64_t entry)
{
...
void Background_W_MUVM::Init(TTree *tree)
{
...
Bool_t Background_W_MUVM::Notify()
{
...
void Background_W_MUVM::Show(Long64_t entry)
{
...
Int_t Background_W_MUVM::Cut(Long64_t entry)
{
...
#endif // #ifdef Background_W_MUVM_cxx
