...
do
  ...
  do
    ...
    new_h="./bin/ATLAS/Ve$V""_mass_$m"".h"
    new_C="./bin/ATLAS/Ve$V""_mass_$m"".C"
    sed -i "s%./bin/ATLAS/Ve1_mass_30.h%$new_h%g" $name_tag".C"
    sed -i "s%./bin/ATLAS/Ve1_mass_30.C%$new_C%g" $name_tag".C"
