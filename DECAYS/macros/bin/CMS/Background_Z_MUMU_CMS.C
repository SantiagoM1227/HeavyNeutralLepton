#define Background_Z_MUMU_CMS_cxx
#include "Background_Z_MUMU_CMS.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void Background_Z_MUMU_CMS::Loop()
{
//   In a ROOT session, you can do:
//      root> .L Background_Z_MUMU_CMS.C
//      root> Background_Z_MUMU_CMS t
