...
// Mon Apr 17 17:55:41 2023 by ROOT version 6.28/00
// from TTree Delphes/Analysis tree
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/QCD_CMS/Events/run_01/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Background_QCD_CMS_h
#define Background_QCD_CMS_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Background_QCD_CMS(TTree *tree=0);
   virtual ~Background_QCD_CMS();
...
#ifdef Background_QCD_CMS_cxx
Background_QCD_CMS::Background_QCD_CMS(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/QCD_CMS/Events/run_01/tag_1_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/QCD_CMS/Events/run_01/tag_1_delphes_events.root");
      }
...
Background_QCD_CMS::~Background_QCD_CMS()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Background_QCD_CMS::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Background_QCD_CMS::LoadTree(Long64_t entry)
{
...
void Background_QCD_CMS::Init(TTree *tree)
{
...
Bool_t Background_QCD_CMS::Notify()
{
...
void Background_QCD_CMS::Show(Long64_t entry)
{
...
Int_t Background_QCD_CMS::Cut(Long64_t entry)
{
...
#endif // #ifdef Background_QCD_CMS_cxx
