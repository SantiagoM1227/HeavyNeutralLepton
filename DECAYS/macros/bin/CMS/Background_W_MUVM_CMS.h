...
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/W_MUVM_CMS/Events/run_01/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Background_W_MUVM_CMS_h
#define Background_W_MUVM_CMS_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3883;
   static constexpr Int_t kMaxTrack = 181;
   static constexpr Int_t kMaxTower = 281;
   static constexpr Int_t kMaxEFlowTrack = 181;
   static constexpr Int_t kMaxEFlowPhoton = 103;
   static constexpr Int_t kMaxEFlowNeutralHadron = 161;
   ...
   Background_W_MUVM_CMS(TTree *tree=0);
   virtual ~Background_W_MUVM_CMS();
...
#ifdef Background_W_MUVM_CMS_cxx
Background_W_MUVM_CMS::Background_W_MUVM_CMS(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/W_MUVM_CMS/Events/run_01/tag_1_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/W_MUVM_CMS/Events/run_01/tag_1_delphes_events.root");
      }
...
Background_W_MUVM_CMS::~Background_W_MUVM_CMS()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Background_W_MUVM_CMS::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Background_W_MUVM_CMS::LoadTree(Long64_t entry)
{
...
void Background_W_MUVM_CMS::Init(TTree *tree)
{
...
Bool_t Background_W_MUVM_CMS::Notify()
{
...
void Background_W_MUVM_CMS::Show(Long64_t entry)
{
...
Int_t Background_W_MUVM_CMS::Cut(Long64_t entry)
{
...
#endif // #ifdef Background_W_MUVM_CMS_cxx
