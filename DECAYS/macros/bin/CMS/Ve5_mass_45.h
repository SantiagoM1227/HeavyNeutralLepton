...
// Mon Apr 17 18:00:48 2023 by ROOT version 6.28/00
// from TTree Delphes/Analysis tree
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_20/Ve5_mass_45_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Ve5_mass_45_h
#define Ve5_mass_45_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3545;
   static constexpr Int_t kMaxTrack = 138;
   static constexpr Int_t kMaxTower = 259;
   static constexpr Int_t kMaxEFlowTrack = 138;
...
#ifdef Ve5_mass_45_cxx
Ve5_mass_45::Ve5_mass_45(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_20/Ve5_mass_45_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_20/Ve5_mass_45_delphes_events.root");
      }
...
Ve5_mass_45::~Ve5_mass_45()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Ve5_mass_45::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Ve5_mass_45::LoadTree(Long64_t entry)
{
...
void Ve5_mass_45::Init(TTree *tree)
{
...
void Ve5_mass_45::Show(Long64_t entry)
{
...
Int_t Ve5_mass_45::Cut(Long64_t entry)
{
