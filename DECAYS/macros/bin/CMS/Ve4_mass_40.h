...
// Mon Apr 17 18:00:44 2023 by ROOT version 6.28/00
// from TTree Delphes/Analysis tree
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_14/Ve4_mass_40_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Ve4_mass_40_h
#define Ve4_mass_40_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4340;
   static constexpr Int_t kMaxTrack = 161;
   static constexpr Int_t kMaxTower = 303;
   static constexpr Int_t kMaxEFlowTrack = 161;
...
#ifdef Ve4_mass_40_cxx
Ve4_mass_40::Ve4_mass_40(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_14/Ve4_mass_40_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_14/Ve4_mass_40_delphes_events.root");
      }
...
Ve4_mass_40::~Ve4_mass_40()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Ve4_mass_40::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Ve4_mass_40::LoadTree(Long64_t entry)
{
...
void Ve4_mass_40::Init(TTree *tree)
{
...
void Ve4_mass_40::Show(Long64_t entry)
{
...
Int_t Ve4_mass_40::Cut(Long64_t entry)
{
