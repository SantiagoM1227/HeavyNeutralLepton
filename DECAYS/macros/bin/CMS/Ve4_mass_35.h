...
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_09/Ve4_mass_35_delphes_events.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4105;
   static constexpr Int_t kMaxTrack = 160;
   static constexpr Int_t kMaxTower = 289;
   static constexpr Int_t kMaxEFlowTrack = 160;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_09/Ve4_mass_35_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_09/Ve4_mass_35_delphes_events.root");
      }
