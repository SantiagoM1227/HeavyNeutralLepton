...
// Mon Apr 17 18:00:46 2023 by ROOT version 6.28/00
// from TTree Delphes/Analysis tree
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_18/Ve3_mass_45_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Ve3_mass_45_h
#define Ve3_mass_45_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3532;
   static constexpr Int_t kMaxTrack = 108;
   static constexpr Int_t kMaxTower = 271;
   static constexpr Int_t kMaxEFlowTrack = 108;
   static constexpr Int_t kMaxEFlowPhoton = 77;
...
#ifdef Ve3_mass_45_cxx
Ve3_mass_45::Ve3_mass_45(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_18/Ve3_mass_45_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_18/Ve3_mass_45_delphes_events.root");
      }
...
Ve3_mass_45::~Ve3_mass_45()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Ve3_mass_45::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Ve3_mass_45::LoadTree(Long64_t entry)
{
...
void Ve3_mass_45::Init(TTree *tree)
{
...
void Ve3_mass_45::Show(Long64_t entry)
{
...
Int_t Ve3_mass_45::Cut(Long64_t entry)
{
