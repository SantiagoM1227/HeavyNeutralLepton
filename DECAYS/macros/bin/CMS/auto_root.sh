...
do
  for V in {1..5}
  do
    path_to_event="/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_0$i/"
    name_tag_1="Ve$V"
...
do
  for V in 5
  do
    path_to_event="/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_CMS/Events/run_$i/"
    name_tag_1="Ve$V"
    name_tag_2="$name_tag_1""_mass_$m"
    name_root="$name_tag_2""_delphes_events.root"
    full_path="$path_to_event""$name_root"
