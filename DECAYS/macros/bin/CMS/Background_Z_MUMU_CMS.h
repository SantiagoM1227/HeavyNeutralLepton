...
// Mon Apr 17 17:55:40 2023 by ROOT version 6.28/00
// from TTree Delphes/Analysis tree
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/Z_MUMU_CMS/Events/run_01/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Background_Z_MUMU_CMS_h
#define Background_Z_MUMU_CMS_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxTrack = 140;
   static constexpr Int_t kMaxTower = 251;
   static constexpr Int_t kMaxEFlowTrack = 140;
   static constexpr Int_t kMaxEFlowPhoton = 84;
   static constexpr Int_t kMaxEFlowNeutralHadron = 150;
   ...
   Background_Z_MUMU_CMS(TTree *tree=0);
   virtual ~Background_Z_MUMU_CMS();
...
#ifdef Background_Z_MUMU_CMS_cxx
Background_Z_MUMU_CMS::Background_Z_MUMU_CMS(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/Z_MUMU_CMS/Events/run_01/tag_1_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/Z_MUMU_CMS/Events/run_01/tag_1_delphes_events.root");
      }
...
Background_Z_MUMU_CMS::~Background_Z_MUMU_CMS()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Background_Z_MUMU_CMS::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Background_Z_MUMU_CMS::LoadTree(Long64_t entry)
{
...
void Background_Z_MUMU_CMS::Init(TTree *tree)
{
...
Bool_t Background_Z_MUMU_CMS::Notify()
{
...
void Background_Z_MUMU_CMS::Show(Long64_t entry)
{
...
Int_t Background_Z_MUMU_CMS::Cut(Long64_t entry)
{
...
#endif // #ifdef Background_Z_MUMU_CMS_cxx
