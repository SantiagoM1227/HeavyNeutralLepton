...
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/QCD_ATLAS/Events/run_01/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Background_QCD_ATLAS_h
#define Background_QCD_ATLAS_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxTower = 274;
   ...
   Background_QCD_ATLAS(TTree *tree=0);
   virtual ~Background_QCD_ATLAS();
...
#ifdef Background_QCD_ATLAS_cxx
Background_QCD_ATLAS::Background_QCD_ATLAS(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/QCD_ATLAS/Events/run_01/tag_1_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/QCD_ATLAS/Events/run_01/tag_1_delphes_events.root");
      }
...
Background_QCD_ATLAS::~Background_QCD_ATLAS()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Background_QCD_ATLAS::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Background_QCD_ATLAS::LoadTree(Long64_t entry)
{
...
void Background_QCD_ATLAS::Init(TTree *tree)
{
...
Bool_t Background_QCD_ATLAS::Notify()
{
...
void Background_QCD_ATLAS::Show(Long64_t entry)
{
...
Int_t Background_QCD_ATLAS::Cut(Long64_t entry)
{
...
#endif // #ifdef Background_QCD_ATLAS_cxx
