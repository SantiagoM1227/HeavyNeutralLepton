...
// Sat Apr 15 12:37:59 2023 by ROOT version 6.28/00
// from TTree Delphes/Analysis tree
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/Z_MUMU_ATLAS/Events/run_01/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Background_Z_MUMU_ATLAS_h
#define Background_Z_MUMU_ATLAS_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3658;
   static constexpr Int_t kMaxTrack = 137;
   static constexpr Int_t kMaxTower = 251;
   static constexpr Int_t kMaxEFlowTrack = 137;
   static constexpr Int_t kMaxEFlowPhoton = 81;
   static constexpr Int_t kMaxEFlowNeutralHadron = 155;
   ...
   Background_Z_MUMU_ATLAS(TTree *tree=0);
   virtual ~Background_Z_MUMU_ATLAS();
...
#ifdef Background_Z_MUMU_ATLAS_cxx
Background_Z_MUMU_ATLAS::Background_Z_MUMU_ATLAS(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/Z_MUMU_ATLAS/Events/run_01/tag_1_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/Z_MUMU_ATLAS/Events/run_01/tag_1_delphes_events.root");
      }
...
Background_Z_MUMU_ATLAS::~Background_Z_MUMU_ATLAS()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Background_Z_MUMU_ATLAS::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Background_Z_MUMU_ATLAS::LoadTree(Long64_t entry)
{
...
void Background_Z_MUMU_ATLAS::Init(TTree *tree)
{
...
Bool_t Background_Z_MUMU_ATLAS::Notify()
{
...
void Background_Z_MUMU_ATLAS::Show(Long64_t entry)
{
...
Int_t Background_Z_MUMU_ATLAS::Cut(Long64_t entry)
{
...
#endif // #ifdef Background_Z_MUMU_ATLAS_cxx
