...
// Sat Apr 15 12:37:58 2023 by ROOT version 6.28/00
// from TTree Delphes/Analysis tree
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/W_MUVM_ATLAS/Events/run_01/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Background_W_MUVM_ATLAS_h
#define Background_W_MUVM_ATLAS_h
...
public :
   ...
   TH1F *hist_Muplus_eta = new TH1F("#eta for #mu +","#eta for #mu +; (#mu +)#eta; Events",50,20,70);
   TH1F *hist_Muminus_eta = new TH1F("#eta for #mu -","#eta for #mu -; (#mu -)#eta; Events",50,20,70);
   TH1F *hist_MuW_eta = new TH1F("#eta for #mu W","#eta for #mu W; (#mu W)#eta; Events",50,20,70);
   TH1F *hist_MuN_eta = new TH1F("#eta for #mu N","#eta for #mu N; (#mu N)#eta; Events",50,20,70);      
   TH1F *hist_jet_eta = new TH1F("#eta for Jets","#eta for Jets; #eta; Events",200,0,200);
   
   TH1F *hist_Muplus_phi = new TH1F("#phi for #mu +","#phi for #mu +; (#mu +)#phi; Events",50,20,70);
   TH1F *hist_Muminus_phi = new TH1F("#phi for #mu -","#phi for #mu -; (#mu -)#phi; Events",50,20,70);
   TH1F *hist_MuW_phi = new TH1F("#phi for #mu W","#phi for #mu W; (#mu W)#phi; Events",50,20,70);
   TH1F *hist_MuN_phi = new TH1F("#phi for #mu N","#phi for #mu N; (#mu N)#phi; Events",50,20,70);      
   TH1F *hist_jet_phi = new TH1F("#phi for Jets","#phi for Jets; #phi; Events",200,0,200);

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxEvent = 1;
   static constexpr Int_t kMaxWeight = 2;
   static constexpr Int_t kMaxParticle = 3624;
   static constexpr Int_t kMaxTrack = 169;
   static constexpr Int_t kMaxTower = 273;
   static constexpr Int_t kMaxEFlowTrack = 169;
   static constexpr Int_t kMaxEFlowPhoton = 95;
   ...
   Background_W_MUVM_ATLAS(TTree *tree=0);
   virtual ~Background_W_MUVM_ATLAS();
...
#ifdef Background_W_MUVM_ATLAS_cxx
Background_W_MUVM_ATLAS::Background_W_MUVM_ATLAS(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/W_MUVM_ATLAS/Events/run_01/tag_1_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/W_MUVM_ATLAS/Events/run_01/tag_1_delphes_events.root");
      }
...
Background_W_MUVM_ATLAS::~Background_W_MUVM_ATLAS()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Background_W_MUVM_ATLAS::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Background_W_MUVM_ATLAS::LoadTree(Long64_t entry)
{
...
void Background_W_MUVM_ATLAS::Init(TTree *tree)
{
...
Bool_t Background_W_MUVM_ATLAS::Notify()
{
...
void Background_W_MUVM_ATLAS::Show(Long64_t entry)
{
...
Int_t Background_W_MUVM_ATLAS::Cut(Long64_t entry)
{
...
#endif // #ifdef Background_W_MUVM_ATLAS_cxx
