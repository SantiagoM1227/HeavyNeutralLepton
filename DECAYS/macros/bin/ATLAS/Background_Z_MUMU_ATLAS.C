#define Background_Z_MUMU_ATLAS_cxx
#include "Background_Z_MUMU_ATLAS.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void Background_Z_MUMU_ATLAS::Loop()
{
//   In a ROOT session, you can do:
//      root> .L Background_Z_MUMU_ATLAS.C
//      root> Background_Z_MUMU_ATLAS t
