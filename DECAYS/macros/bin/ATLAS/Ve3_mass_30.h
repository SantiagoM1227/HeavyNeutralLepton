...
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_ATLAS/Events/run_03/Ve3_mass_30_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Ve3_mass_30_h
#define Ve3_mass_30_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3941;
...
#ifdef Ve3_mass_30_cxx
Ve3_mass_30::Ve3_mass_30(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_ATLAS/Events/run_03/Ve3_mass_30_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/HNL_MU_JJ_ATLAS/Events/run_03/Ve3_mass_30_delphes_events.root");
      }
...
Ve3_mass_30::~Ve3_mass_30()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Ve3_mass_30::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Ve3_mass_30::LoadTree(Long64_t entry)
{
...
void Ve3_mass_30::Init(TTree *tree)
{
...
void Ve3_mass_30::Show(Long64_t entry)
{
...
Int_t Ve3_mass_30::Cut(Long64_t entry)
{
