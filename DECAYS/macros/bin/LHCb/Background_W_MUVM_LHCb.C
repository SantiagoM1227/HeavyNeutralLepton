#define Background_W_MUVM_LHCb_cxx
#include "Background_W_MUVM_LHCb.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void Background_W_MUVM_LHCb::Loop()
{
//   In a ROOT session, you can do:
//      root> .L Background_W_MUVM_LHCb.C
//      root> Background_W_MUVM_LHCb t
