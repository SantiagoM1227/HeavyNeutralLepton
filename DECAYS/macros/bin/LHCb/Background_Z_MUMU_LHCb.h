...
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/Z_MUMU_LHCb/Events/run_01/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Background_Z_MUMU_LHCb_h
#define Background_Z_MUMU_LHCb_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3723;
   static constexpr Int_t kMaxTrack = 654;
   static constexpr Int_t kMaxTower = 372;
   static constexpr Int_t kMaxEFTrack = 183;
   static constexpr Int_t kMaxNeutralHadron = 157;
   static constexpr Int_t kMaxPhoton = 161;
   ...
   Background_Z_MUMU_LHCb(TTree *tree=0);
   virtual ~Background_Z_MUMU_LHCb();
...
#ifdef Background_Z_MUMU_LHCb_cxx
Background_Z_MUMU_LHCb::Background_Z_MUMU_LHCb(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/Z_MUMU_LHCb/Events/run_01/tag_1_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/Z_MUMU_LHCb/Events/run_01/tag_1_delphes_events.root");
      }
...
Background_Z_MUMU_LHCb::~Background_Z_MUMU_LHCb()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Background_Z_MUMU_LHCb::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Background_Z_MUMU_LHCb::LoadTree(Long64_t entry)
{
...
void Background_Z_MUMU_LHCb::Init(TTree *tree)
{
...
Bool_t Background_Z_MUMU_LHCb::Notify()
{
...
void Background_Z_MUMU_LHCb::Show(Long64_t entry)
{
...
Int_t Background_Z_MUMU_LHCb::Cut(Long64_t entry)
{
...
#endif // #ifdef Background_Z_MUMU_LHCb_cxx
