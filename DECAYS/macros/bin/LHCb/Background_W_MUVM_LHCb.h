...
// Mon Apr 17 22:44:54 2023 by ROOT version 6.28/00
// from TTree Delphes/Analysis tree
// found on file: /home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/W_MUVM_LHCb/Events/run_01/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef Background_W_MUVM_LHCb_h
#define Background_W_MUVM_LHCb_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4006;
   static constexpr Int_t kMaxTrack = 750;
   static constexpr Int_t kMaxTower = 427;
   static constexpr Int_t kMaxEFTrack = 196;
   static constexpr Int_t kMaxNeutralHadron = 188;
   static constexpr Int_t kMaxPhoton = 155;
   ...
   Background_W_MUVM_LHCb(TTree *tree=0);
   virtual ~Background_W_MUVM_LHCb();
...
#ifdef Background_W_MUVM_LHCb_cxx
Background_W_MUVM_LHCb::Background_W_MUVM_LHCb(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/W_MUVM_LHCb/Events/run_01/tag_1_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/santi/Documents/TOOLS/MG5_aMC_v3_1_1/bin/W_MUVM_LHCb/Events/run_01/tag_1_delphes_events.root");
      }
...
Background_W_MUVM_LHCb::~Background_W_MUVM_LHCb()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Background_W_MUVM_LHCb::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Background_W_MUVM_LHCb::LoadTree(Long64_t entry)
{
...
void Background_W_MUVM_LHCb::Init(TTree *tree)
{
...
Bool_t Background_W_MUVM_LHCb::Notify()
{
...
void Background_W_MUVM_LHCb::Show(Long64_t entry)
{
...
Int_t Background_W_MUVM_LHCb::Cut(Long64_t entry)
{
...
#endif // #ifdef Background_W_MUVM_LHCb_cxx
